...
- `cursor/rules.md`: **Cursor Rules（補助金MCPチャット）** - コーディング規約、セキュリティ/コンプラ、テスト方針、Git運用など
- `docs/progress-summary.md`: **作業進捗と要件定義のまとめ**（全体像を把握する際に最初に読むことを推奨）
